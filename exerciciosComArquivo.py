...
for i in dic_usuarios:
    ...
    total_espaco_ocuapdo = total_espaco_ocuapdo + mb
print(dic_usuarios)
espaco_livre = 3000 - total_espaco_ocuapdo
with open("relatório.txt", "w") as info:
    info.write("\nACME Inc.               Uso do espaço em disco pelos usuários\n"
               "------------------------------------------------------------------------\n"
               "Espaço Total   = 3000 MB\n"
               f"Espaço Ocupado = {total_espaco_ocuapdo:.2f} MB\n"
               f"Espaço Livre   = {3000 - total_espaco_ocuapdo:.2f} MB\n"
               "------------------------------------------------------------------------\n"
               "Nr.  Usuário        Espaço utilizado     % do uso\n")
    x = 1
    for i in dic_usuarios:
